...
public class Schedules {
	...
	public void getWebData() throws Exception {
		if (fetch) {
			...
			Document doc = Jsoup.connect("http://nba.sports.sina.com.cn/match_result.php?day=0&years="
					+ DateTool.getNowYear() + "&months=" + DateTool.getNowMonthString() + "&teams=").timeout(0).get();
